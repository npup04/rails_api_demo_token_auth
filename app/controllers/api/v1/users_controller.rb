module Api
  module V1
    class UsersController < ApplicationController
      # before_filter forces authentication for all of the following actions. It is a controller method.
      ...
      def sign_in
        ...
        #authenticate method here is from the has_secure_password method from user.rb
